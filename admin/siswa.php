...
<table class="table table-striped table-bordered">
    ...
    <tr>
        ...
        <td><a href="?url=edit-siswa&nisn=<?= $data['nisn'] ?>" class='btn btn-warning'>EDIT</a></td>
        <td><a onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data')" href="?url=hapus-siswa&nisn=<? 
        $data['nisn'] ?>" class='btn btn-danger'>HAPUS</a></td>
    </tr>
