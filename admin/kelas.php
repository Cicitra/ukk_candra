...
<table class="table table-striped table-bordered">
    ...
    <tr>
        ...
        <td><a href="?url=edit-kelas&id_kelas=<? $data['id_kelas'] ?>" class='btn btn-warning'>EDIT</a></td>
        <td><a onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data')" 
        href="?url=hapus-kelas&id_kelas=<?=$data['id_kelas'] ?>" class='btn btn-danger'>HAPUS</a></td>
    </tr>
    <?php } ?>
